...
public class Score {
	...
	//스태틱메서드를 만들 때 : 인스턴스변수 사용 유무 (인스턴스변수 사용하지 않는 매서드)
	//스태틱메서드와 인스턴스메서드를 사용할 때 : 매서드의 호출의 기준 객체생성의 유무
	//스태틱메서드: 객체생성관 관련없음	클래스명.매서드()
	//인스턴스매서드 : 객체생성과 관련있음, 객체생성이후부터 사용할 수 있는 메서드
